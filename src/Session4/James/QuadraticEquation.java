...
class Main {
    public static void main(String[] args) {
        QuadraticEquation quadraticEquation = new QuadraticEquation(9, 2, -1);
        System.out.println(quadraticEquation);
        if (!quadraticEquation.checkDelta()) {
            System.out.println("Vô nghiệm");
        } else {
            System.out.println("Nghiệm 1 : " + Math.floor(quadraticEquation.getRoot2() * 100) / 100);
            System.out.println("Nghiệm 2 : " + (double) Math.round(quadraticEquation.getRoot2()));
        }
    }
}